  ...
  return (
    <div className={fullWidth ? 'w-full' : ''}>
      ...
      <div className="relative">
        {icon && <div className="absolute left-3 top-1/2 -translate-y-1/2 text-#C4FF00">{icon}</div>}
        <input
          className={`
            w-full px-4 py-2.5 rounded-lg
            bg-gray-800/50 border border-gray-700 text-[#0D1B2A]
            placeholder:text-[#0D1B2A]/30
            focus:outline-none focus:border-#C4FF00 focus:ring-2 focus:ring-#C4FF00/20
