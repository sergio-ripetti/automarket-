...
export default function Footer() {
  return (
    <footer className="bg-[#FAFBFC] border-t border-blue-700/10 mt-20 lg:mt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-bebas text-xl tracking-wider text-blue-700">AutoMarket</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map(({ icon: Icon, label, href }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-10 h-10 rounded-lg bg-white/5 hover:bg-blue-700/20 border border-white/10 hover:border-blue-700/30 flex items-center justify-center text-white/60 hover:text-blue-700 transition-all duration-sm group focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-700"
                >
                  <Icon size={18} />
                </a>
              ))}
            ...
            <ul className="space-y-3">
              {footerLinks.map((link) => (
                <li key={link.to}>
                  <Link
                    to={link.to}
                    className="font-poppins text-sm text-white/60 hover:text-blue-700 transition-colors duration-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-700 rounded px-2 py-1"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin size={18} className="text-blue-700 mt-0.5 shrink-0" aria-hidden="true" />
              ...
              <li className="flex items-center gap-3">
                <Phone size={18} className="text-blue-700 shrink-0" aria-hidden="true" />
                <a
                  href="tel:+64912345 67"
                  className="font-poppins text-sm text-white/60 hover:text-blue-700 transition-colors duration-sm"
                >
                  +64 9 123 4567
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} className="text-blue-700 shrink-0" aria-hidden="true" />
                <a
