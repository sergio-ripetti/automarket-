          ...
          <div key={s}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.5rem' }}>
              <div style={{
                ...
                backgroundColor: s < step ? '#22c55e' : s === step ? '#2E86AB' : 'rgba(255,255,255,0.1)',
              ...
              <span className="font-bebas" style={{
                fontSize: '0.9rem', color: s === step ? '#2E86AB' : 'rgba(255,255,255,0.5)',
              }}>
          ...
          <div style={{ position: 'relative', marginBottom: '2rem' }}>
            ...
            <input
              ...
              style={{
                ...
                backgroundColor: '#EEF2F7', border: '1px solid rgba(255,255,255,0.08)', color: 'white',
                fontFamily: 'Outfit', fontSize: '0.875rem', outline: 'none',
              }}
              onFocus={(e) => { e.currentTarget.style.borderColor = '#2E86AB'; setCarsOpen(true) }}
                ...
                {filteredCars.map((c) => (
                  ...
                  >
                    <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                      ...
                      <p className="font-bebas" style={{ fontSize: '0.9rem', color: '#2E86AB' }}>{fmt(c.price)}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {selectedCar && (
            <>
              <div style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    color: '#2E86AB', fontFamily: 'Outfit', fontSize: '0.875rem',
              ...
              <div style={{
                ...
                <h3 className="font-bebas" style={{ fontSize: '1.25rem', color: '#2E86AB', marginBottom: '1rem' }}>Vehicle Details *</h3>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        backgroundColor: '#EEF2F7', border: '1px solid rgba(255,255,255,0.08)',
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                      <button
                        ...
                        style={{
                          ...
                          backgroundColor: form.hasMaintenanceHistory ? '#2E86AB' : 'rgba(255,255,255,0.1)',
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    border: `2px solid ${form.paymentType === type ? '#2E86AB' : 'transparent'}`,
                  ...
                  {[12, 24, 36, 48, 60].map((m) => (
                    <button
                      ...
                      style={{
                        ...
                        backgroundColor: form.loanTerm === m ? '#2E86AB' : 'rgba(255,255,255,0.1)',
          ...
          <div style={{ marginBottom: '1.5rem', backgroundColor: '#FFFFFF', borderRadius: '0.875rem', border: '1px solid rgba(255,255,255,0.06)', overflow: 'hidden' }}>
            <button
              ...
              style={{
                ...
                border: 'none', color: '#2E86AB', fontFamily: 'Outfit', fontSize: '0.9rem',
